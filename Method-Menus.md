...
| **Copilot in Power BI** *(if enabled)* | Drafts pages, suggests visuals, writes narrative summaries in seconds. | Needs tenant + capacity setting on; quality depends on good column names and descriptions. | [Copilot in Power BI](https://learn.microsoft.com/power-bi/create-reports/copilot-introduction) · [Enable Copilot](https://learn.microsoft.com/fabric/get-started/copilot-enable-fabric) |
| **Fabric Data Agent** *(if enabled)* | Natural-language Q&A grounded on your lakehouse; great for exec users. | Preview capability; answers only as good as your metadata. | [Fabric Data Agent overview](https://learn.microsoft.com/fabric/data-science/concept-data-agent) · [Create a Data Agent](https://learn.microsoft.com/fabric/data-science/how-to-create-data-agent) |
