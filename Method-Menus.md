...
| **Fabric Org App** | Curated bundle of reports and dashboards for a consumer audience. | Consumers still need appropriate licences. | [Org apps in Fabric](https://learn.microsoft.com/power-bi/explore-reports/org-app-items) |
